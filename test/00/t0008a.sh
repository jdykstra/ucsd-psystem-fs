...
date > $testdir/mnt/ijkl
test $? -eq 0 || umount_and_no_result

#
# rename with no 2nd file delete
#
mv $testdir/mnt/abcd $testdir/mnt/mnop
test $? -eq 0 || umount_and_fail

#
# rename with 2nd file delete
#
mv $testdir/mnt/ijkl $testdir/mnt/efgh
test $? -eq 0 || umount_and_fail
