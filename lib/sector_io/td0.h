...
#ifndef LIB_SECTOR_IO_TD0_H
#define LIB_SECTOR_IO_TD0_H

#include <lib/sector_io.h>

/**
  * The sector_io_td0 class is used to represent access to a disk image
  * in Teledisk TD0 format.
  *
  * For a description of this format see...
  * http://www.classiccmp.org/dunfield/img/td0notes.txt
  *
  * Or maybe this...
...
private:
    /**
      ...
      */
    sector_io_td0(const rcstring &filename);
...
public:
    ...
    /**
      ...
      * is a candidate for being in the TD0 format.
      */
...
private:
    ...
    /**
      ...
      */
    sector_io_td0(const sector_io_td0 &);

    /**
      * The assignment operator.  Do not use.
      */
    sector_io_td0 &operator=(const sector_io_td0 &);
};

#endif // LIB_SECTOR_IO_TD0_H
